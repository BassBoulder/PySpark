...
def compile_ingredients(dishes):
    ...
    for dish in dishes:
        combined_ingredients.update(dish)
...
def separate_appetizers(dishes, appetizers):
    ...
    mains_only = set_dishes.difference(set_appetizers)

    return list(mains_only)
...
def singleton_ingredients(dishes, intersection):
    ...
    every_ingredient = set()
    unique_ingredient = set()
    
    for dish in dishes:
        every_ingredient.update(dish)

    unique_ingredient = every_ingredient - intersection
